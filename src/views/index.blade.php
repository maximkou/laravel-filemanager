...
<head>
  ...
  <style>{!! \File::get(base_path('vendor/maximkou/laravel-filemanager/public/css/lfm.css')) !!}</style>
...
<body>
  ...
  <script>{!! \File::get(base_path('vendor/maximkou/laravel-filemanager/public/js/script.js')) !!}</script>
